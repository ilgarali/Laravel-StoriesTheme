...
@section('content')
<section class="hero-wrap hero-wrap-2" style="background-image: url({{asset($single->img)}});">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 order-lg-last ftco-animate">
                <h2 class="mb-3">{{$single->title}}</h2>
             <p>{{$single->content}}</p>
                <div class="tag-widget post-tag-container mb-5 mt-5">
                    <div class="tagcloud">
                        <a href="{{route('category',$single->category->slug)}}" class="tag-cloud-link">{{$single->category->category}}</a>
            ...
            <div class="col-lg-4 sidebar pr-lg-5 ftco-animate">
                ...
                <div class="sidebar-box ftco-animate">
                    <ul class="categories">
                        ...
                        <li><a href="{{route('category',$category->slug)}}">{{$category->category}} <span>({{$category->posts->count()}})</span></a></li>
                            @endforeach
